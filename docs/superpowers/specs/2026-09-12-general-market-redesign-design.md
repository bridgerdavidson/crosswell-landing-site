...
- Open: chapter 03 (the dark chat chapter) and chapter 04 (the pipeline with its own "Who is this?" prompts, Redrock Flips still at term sheet) now repeat much of this chapter's story; decide whether to cut, rework, or merge them. The floating chat card held in reserve for the chat chapter may no longer be needed.
