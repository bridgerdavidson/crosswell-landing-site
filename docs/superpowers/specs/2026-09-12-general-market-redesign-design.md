...
- Open: lighting (what is lit, what recedes) and whether anything is clickable; the chapter's body still names "the quarter's rocks", which the page no longer shows.
