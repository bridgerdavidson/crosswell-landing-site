...
- **No drawings.** Two were tried beside the names, in the stack's hand (the audit as three things the company knows with the route walked between them and the dropped place ringed; onboarding as the stack itself, installed and on), and read badly at 96 beside the serif names. The rows are the words: name, duration, what happens.
