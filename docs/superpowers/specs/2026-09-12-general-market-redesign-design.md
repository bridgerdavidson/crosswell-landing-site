...
- The window has no outline. Its chrome (the rail and the Core's column, and the lifted Core in chapter 02) is `chrome` (#e9e5dc), a step darker than the page's ivory, and its page is parchment, a step lighter, so the window reads against the page by colour alone (2026-09-15; prototype and site alike).
